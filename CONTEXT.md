...
- **Exceptions tab overdue thresholds (settled 2026-09-18)**: two distinct "overdue" signals feed the exceptions tab, because their underlying cadence certainty is different.
  ...
  - **Open follow-on**: a Mission-level settings screen (to hold this threshold, and presumably other Mission-wide config) implies a Mission-level staff/CFO account type distinct from the local-church Clerk/Treasurer/Pastor roles defined elsewhere in this doc — that role hasn't been formally specified yet.
