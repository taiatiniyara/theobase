  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <main>
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
              {[
                ...
                <div key={stat.label} className="text-center">
                  <div className="font-heading text-2xl font-bold tracking-wide text-neutral-900 sm:text-3xl dark:text-neutral-100">
                    {stat.value}
                  </div>
        ...
        <section className="border-t border-neutral-100 py-20 sm:py-28 dark:border-neutral-800">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-3">
              <div className="group rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md sm:p-8 dark:border-neutral-700 dark:bg-neutral-800">
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-brand-100 text-brand-600 dark:bg-brand-900 dark:text-brand-400">
              ...
              <div className="group rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md sm:p-8 dark:border-neutral-700 dark:bg-neutral-800">
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-warning-100 text-warning-700 dark:bg-warning-900/40 dark:text-warning-400">
                ...
                <p className="mt-4 text-xs font-medium text-warning-700 dark:text-warning-400">
                  Dual-signoff enforced by software &rarr;
                </p>
              </div>
              <div className="group rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md sm:p-8 dark:border-neutral-700 dark:bg-neutral-800">
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-success-light text-success-700 dark:bg-green-900/40 dark:text-success">
                ...
                <p className="mt-4 text-xs font-medium text-success-700 dark:text-success">
        ...
        <section className="bg-neutral-50 py-20 sm:py-28 dark:bg-neutral-900/20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="font-heading text-2xl font-bold tracking-wide text-neutral-900 sm:text-3xl dark:text-neutral-100">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8 dark:border-neutral-700 dark:bg-neutral-800">
        ...
        <section className="py-20 sm:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8 dark:border-neutral-700 dark:bg-neutral-800">
                <FileText className="mb-4 h-8 w-8 text-warning-600 dark:text-warning-400" />
                <div className="text-xs font-semibold uppercase tracking-wider text-warning-600 dark:text-warning-400">
                  Today
                </div>
                <p className="mt-3 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
              ...
              <div className="rounded-2xl border border-brand-200 bg-brand-50 p-6 shadow-sm sm:p-8 dark:border-brand-800 dark:bg-brand-950/30">
                <Sparkles className="mb-4 h-8 w-8 text-brand-600 dark:text-brand-400" />
        ...
        <section className="border-t border-neutral-100 bg-neutral-50 py-20 sm:py-28 dark:border-neutral-800 dark:bg-neutral-900/20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                ...
                <button
                  type="button"
                  onClick={() => navigate({ to: '/login' })}
                  className="rounded-xl px-7 py-4 text-base font-medium text-neutral-500 transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100"
                >
                  Sign in
                </button>
              </div>
