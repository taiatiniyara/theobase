        ...
        <section className="border-b border-neutral-100 py-24 dark:border-neutral-800 sm:py-32">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mx-auto max-w-2xl">
              ...
              <p className="mt-6 text-lg leading-relaxed text-neutral-600 dark:text-neutral-400">
                Theobase is on a roadmap to become the standard operating software
                for every local church in the global SDA Church &mdash; the platform
                every clerk, treasurer, and counter opens on Sabbath morning.
              </p>
              <p className="mt-4 leading-relaxed text-neutral-500 dark:text-neutral-400">
                Starting with the Pacific, expanding conference by conference.
              </p>
              <div className="mt-10 grid gap-8 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
                    Hundreds of SDA churches still run on paper notebooks, shared
                    spreadsheets, and re-typed reports. Church officers spend hours
                    each week on paperwork that software should handle.
                  </p>
                </div>
                <div>
                  <h3 className="font-heading text-lg font-bold tracking-wide text-neutral-900 dark:text-neutral-100">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
                    One platform that understands SDA polity &mdash; not a generic
                    church app retrofitted for Adventists. Dual-signoff enforced by
                    software. Reports that fill themselves out. A platform that
                    works offline, scales globally, and belongs to the church.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="lg:col-span-2 space-y-20">
                <div>
                  ...
                  <p className="mt-2 leading-relaxed text-neutral-500 dark:text-neutral-400">
                    ...
                    When the Conference asks for the annual report, it&rsquo;s already complete &mdash;
                  ...
                  <p className="mt-3 text-sm text-neutral-400">
                    ...
                    every row, and flags anything it can&rsquo;t resolve for you to review.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 leading-relaxed text-neutral-500 dark:text-neutral-400">
                    ...
                    a large, easy-to-tap keypad &mdash; built for the counting room, not a tiny system keyboard.
                    When both confirm, the totals are compared. If they match, the batch locks forever.
                    If they don&rsquo;t, the difference is shown side by side until you reconcile.
                  </p>
                  <p className="mt-3 text-sm text-neutral-400">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-relaxed text-neutral-500 dark:text-neutral-400">
                    ...
                    When it&rsquo;s time to remit tithe to the Conference, the statement is pre-computed
                    from live data. Total tithe collected. Total offerings. Amount to remit. All there.
                    You review and approve. That&rsquo;s it.
                  </p>
                  <p className="mt-3 text-sm text-neutral-400">
                    Mark batches as deposited with the bank. Track which have been remitted and which are pending.
                    Every member&rsquo;s giving history is searchable and exportable.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 leading-relaxed text-neutral-500 dark:text-neutral-400">
                    ...
                    Count offerings, update member records, review reports &mdash; everything functions offline.
                    When you&rsquo;re back online, changes sync automatically. Nothing is lost.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-16 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2 space-y-10">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
                    Dual-signoff isn&rsquo;t a setting you enable &mdash; it&rsquo;s the only way a batch works. The clerk manages membership, 
                    the treasurer handles money, the counters count. Fourteen role types, each seeing exactly what their
                    job requires. The software enforces the polity, so your officers don&rsquo;t have to police each other.
                  </p>
                </div>
                <div>
                  <h3 className="font-heading text-base font-bold tracking-wide text-neutral-900 dark:text-neutral-100">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
                    ...
                    First-time counters open the app and count today&rsquo;s offering with zero training. 
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
                    ...
                    sees aggregate numbers &mdash; individual member details stay within the local church.
                  </p>
                </div>
                <div>
                  <h3 className="font-heading text-base font-bold tracking-wide text-neutral-900 dark:text-neutral-100">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
                    Who changed this member&rsquo;s status? When was this batch committed? Who approved this report? 
                    Every action leaves an unalterable trail. The audit log shows exactly what happened, 
                    when, and by whom. If someone tries to tamper with a record, it breaks the chain &mdash; detectable instantly.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-lg text-neutral-500 dark:text-neutral-400">
                Or $30/year. The Conference subscribes &mdash; individual churches never receive a bill. 
