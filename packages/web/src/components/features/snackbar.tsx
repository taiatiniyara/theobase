...
export function Snackbar({
  ...
  return (
    <div className="animate-slide-in-from-bottom fixed bottom-20 left-4 right-4 z-50 mx-auto max-w-lg">
      <div className="flex items-center gap-3 rounded-lg bg-neutral-900 px-4 py-3 text-white shadow-md">
        <span
        ...
        {effectiveUndoLabel && onUndo && (
          <button
            ...
            className="shrink-0 rounded px-2 py-1 text-sm font-medium text-brand-400 hover:text-brand-300:text-brand-700 touch-target-min"
          >
            {effectiveUndoLabel}
          </button>
        )}
