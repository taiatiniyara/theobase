...
**Deviation from policy (deliberate):** the Church Manual names the treasurer plus another officer ("preferably a deacon or deaconess") as the cash-count signers, and has no "Counter" office. Theobase's two-unrelated-counters rule and its Counter office are deliberate strengthenings of the dual-signature guarantee — stricter than policy, not a bug. The system enforces Theobase's stronger rule; any future reconciliation with policy can only relax it.
