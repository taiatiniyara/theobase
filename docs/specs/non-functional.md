...
- **Security** — SOC2-ready architecture, certification deferred. Append-only hash-chained event log (ADR-0019); dual signature distinct + unrelated (ADR-0014); Passkey identity (ADR-0016).
